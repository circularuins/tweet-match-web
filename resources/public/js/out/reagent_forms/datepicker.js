...
var temp__4124__auto__ = (function (){var or__3724__auto__ = cljs.core.re_find.call(null,/[.\\/\-\s].*?/,fmt);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [separator,(function (){var pred__8384 = cljs.core._EQ_;
var expr__8385 = separator;
if(cljs.core.truth_(pred__8384.call(null,".",expr__8385))){
return /\./;
} else {
if(cljs.core.truth_(pred__8384.call(null," ",expr__8385))){
return /W+/;
...
var fmt__$1 = (function (){var or__3724__auto__ = fmt;
if(cljs.core.truth_(or__3724__auto__)){
return or__3724__auto__;
} else {
return "mm/dd/yyyy";
...
var vec__8388 = reagent_forms.datepicker.separator_matcher.call(null,fmt__$1);
var separator = cljs.core.nth.call(null,vec__8388,(0),null);
var matcher = cljs.core.nth.call(null,vec__8388,(1),null);
...
var G__8390 = (new Date());
G__8390.setHours((0));

G__8390.setMinutes((0));

G__8390.setSeconds((0));

G__8390.setMilliseconds((0));
...
reagent_forms.datepicker.format_date = (function format_date(p__8408,p__8409){
var map__8412 = p__8408;
var map__8412__$1 = ((cljs.core.seq_QMARK_.call(null,map__8412))?cljs.core.apply.call(null,cljs.core.hash_map,map__8412):map__8412);
var day = cljs.core.get.call(null,map__8412__$1,new cljs.core.Keyword(null,"day","day",-274800446));
var month = cljs.core.get.call(null,map__8412__$1,new cljs.core.Keyword(null,"month","month",-1960248533));
var year = cljs.core.get.call(null,map__8412__$1,new cljs.core.Keyword(null,"year","year",335913393));
...
var parts = cljs.core.get.call(null,map__8413__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var separator = cljs.core.get.call(null,map__8413__$1,new cljs.core.Keyword(null,"separator","separator",-1628749125));
return clojure.string.join.call(null,separator,cljs.core.map.call(null,((function (map__8412,map__8412__$1,day,month,year,map__8413,map__8413__$1,parts,separator){
return (function (p1__8407_SHARP_){
if(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([p1__8407_SHARP_], true),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"d","d",1972142424),new cljs.core.Keyword(null,"dd","dd",-1340437629)], null)))){
return reagent_forms.datepicker.formatted_value.call(null,day);
} else {
if(cljs.core.truth_(cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([p1__8407_SHARP_], true),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"m","m",1632677161),new cljs.core.Keyword(null,"mm","mm",-1652850560)], null)))){
return reagent_forms.datepicker.formatted_value.call(null,month);
} else {
if(cljs.core._EQ_.call(null,p1__8407_SHARP_,new cljs.core.Keyword(null,"yy","yy",-1432012814))){
return [cljs.core.str(year)].join('').substring((2));
} else {
if(cljs.core._EQ_.call(null,p1__8407_SHARP_,new cljs.core.Keyword(null,"yyyy","yyyy",2098225339))){
return year;
} else {
return null;
}
...
});})(map__8412,map__8412__$1,day,month,year,map__8413,map__8413__$1,parts,separator))
,parts));
});
reagent_forms.datepicker.first_day_of_week = (function first_day_of_week(year,month){
return (function (){var G__8415 = (new Date());
G__8415.setYear(year);

G__8415.setMonth(month);
...
reagent_forms.datepicker.gen_days = (function gen_days(p__8416,get,save_BANG_){
var vec__8422 = p__8416;
var year = cljs.core.nth.call(null,vec__8422,(0),null);
var month = cljs.core.nth.call(null,vec__8422,(1),null);
...
return cljs.core.map.call(null,((function (num_days,last_month_days,first_day,vec__8422,year,month){
...
});})(num_days,last_month_days,first_day,vec__8422,year,month))
,cljs.core.partition.call(null,(7),(function (){var iter__4480__auto__ = ((function (num_days,last_month_days,first_day,vec__8422,year,month){
return (function iter__8423(s__8424){
return (new cljs.core.LazySeq(null,((function (num_days,last_month_days,first_day,vec__8422,year,month){
return (function (){
var s__8424__$1 = s__8424;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__8424__$1);
if(temp__4126__auto__){
var s__8424__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__8424__$2)){
var c__4478__auto__ = cljs.core.chunk_first.call(null,s__8424__$2);
var size__4479__auto__ = cljs.core.count.call(null,c__4478__auto__);
var b__8426 = cljs.core.chunk_buffer.call(null,size__4479__auto__);
if((function (){var i__8425 = (0);
while(true){
if((i__8425 < size__4479__auto__)){
var i = cljs.core._nth.call(null,c__4478__auto__,i__8425);
cljs.core.chunk_append.call(null,b__8426,(((i < first_day))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day.old","td.day.old",1008935029),(cljs.core.truth_(last_month_days)?(last_month_days - ((first_day - i) - (1))):null)], null):(((i < (first_day + num_days)))?(function (){var day = ((i - first_day) + (1));
...
})(),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__8425,day,date,i,c__4478__auto__,size__4479__auto__,b__8426,s__8424__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__8422,year,month){
return (function (){
...
});})(i__8425,day,date,i,c__4478__auto__,size__4479__auto__,b__8426,s__8424__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__8422,year,month))
], null),day], null);
...
var i = cljs.core.first.call(null,s__8424__$2);
...
})(),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (day,date,i,s__8424__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__8422,year,month){
return (function (){
if(cljs.core._EQ_.call(null,get.call(null),date)){
return save_BANG_.call(null,null);
} else {
...
});})(day,date,i,s__8424__$2,temp__4126__auto__,num_days,last_month_days,first_day,vec__8422,year,month))
], null),day], null);
})():new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.day.new","td.day.new",500967295),(((month < (11)))?((i - (first_day + num_days)) + (1)):null)], null)
)),iter__8423.call(null,cljs.core.rest.call(null,s__8424__$2)));
}
} else {
return null;
}
...
;
return iter__4480__auto__.call(null,cljs.core.range.call(null,(42)));
})()));
});
reagent_forms.datepicker.last_date = (function last_date(p__8428){
...
reagent_forms.datepicker.next_date = (function next_date(p__8431){
var vec__8433 = p__8431;
var year = cljs.core.nth.call(null,vec__8433,(0),null);
var month = cljs.core.nth.call(null,vec__8433,(1),null);
