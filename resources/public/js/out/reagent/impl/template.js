...
return (function() { 
var G__6870__delegate = function (args){
...
var or__3724__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__6873 = res;
(G__6873[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__6874){
var vec__6876 = p__6874;
var id = cljs.core.nth.call(null,vec__6876,(0),null);
var class$ = cljs.core.nth.call(null,vec__6876,(1),null);
var pid = (props["id"]);
...
var pname_6877 = reagent.impl.template.cached_prop_name.call(null,k);
if(!((pname_6877 === "key"))){
(o[pname_6877] = reagent.impl.template.convert_prop_value.call(null,v));
} else {
}
...
var G__6880 = jsprops;
(G__6880["defaultValue"] = value);

(G__6880["value"] = null);

(G__6880["onChange"] = ((function (G__6880,on_change,value){
return (function (p1__6878_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6878_SHARP_);
});})(G__6880,on_change,value))
);
...
var G__6882 = spec;
(G__6882["componentDidUpdate"] = ((function (G__6882){
return (function (){
var C = this;
...
(G__6882["componentWillUnmount"] = ((function (G__6882){
return (function (){
var C = this;
...
var spec = {"displayName": (function (){var or__3724__auto__ = name;
if(cljs.core.truth_(or__3724__auto__)){
return or__3724__auto__;
} else {
...
return (function (p1__6883_SHARP_,p2__6884_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update.call(null,C,p1__6883_SHARP_,p2__6884_SHARP_);
...
var vec__6886 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__6886,(0),null);
var id = cljs.core.nth.call(null,vec__6886,(1),null);
var class$ = cljs.core.nth.call(null,vec__6886,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3724__auto__ = id;
if(cljs.core.truth_(or__3724__auto__)){
return or__3724__auto__;
} else {
...
var vec__6888 = reagent.impl.template.parse_tag.call(null,tag);
var comp = cljs.core.nth.call(null,vec__6888,(0),null);
var id_class = cljs.core.nth.call(null,vec__6888,(1),null);
...
var jsprops = (function (){var obj6892 = {};
(obj6892[reagent.impl.util.cljs_argv] = v);

(obj6892[reagent.impl.util.cljs_level] = level);

return obj6892;
})();
var k_6893 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
var k_SINGLEQUOTE__6894 = (((k_6893 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_6893);
if((k_SINGLEQUOTE__6894 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__6894);
}
...
var n__4611__auto___6895 = a.length;
var i_6896 = (0);
while(true){
if((i_6896 < n__4611__auto___6895)){
(a[i_6896] = reagent.impl.template.as_component.call(null,(a[i_6896]),level_SINGLEQUOTE_));
...
var n__4611__auto___6898 = a.length;
var i_6899 = (0);
while(true){
if((i_6899 < n__4611__auto___6898)){
if((i_6899 >= first_child)){
(a[i_6899] = reagent.impl.template.as_component.call(null,(a[i_6899]),level));
} else {
}
